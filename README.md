...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  pre { background-color: var(--bg4) !important;}
  tr {background-color: var(--bg3) !important;}
  .markdown-body table tr:nth-child(2n) {background-color: var(--bg3) !important;}
  .markdown-body table tr { background-color: var(--bg3) !important; }
